  ...
  skillGroups: SkillGroup[] = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Google BigQuery', tooltip: 'Cloud data warehouse' },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Gemini', tooltip: 'Google AI model' },
        { name: 'Copilot', tooltip: 'AI pair programming' },
        { name: 'Notepad++', tooltip: 'Code editor' },
        { name: 'Visual Studio', tooltip: 'Microsoft IDE' },
        { name: 'IntelliJ', tooltip: 'JetBrains IDE' },
